...
// include: C:\Users\JB\AppData\Local\Temp\tmpaj19w_qk.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'B:/C++_GAMES/echo_waves/dist/index.data';
...
Module['FS_createPath']("/assets", "sprites", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_B:/C++_GAMES/echo_waves/dist/index.data');
      }
      Module['addRunDependency']('datafile_B:/C++_GAMES/echo_waves/dist/index.data');
    ...
    loadPackage({"files": [{"filename": "/assets/levels/itch_title_level.txt", "start": 0, "end": 364}, {"filename": "/assets/levels/level1_16.txt", "start": 364, "end": 874}, {"filename": "/assets/levels/level2_16.txt", "start": 874, "end": 1176}, {"filename": "/assets/sounds/clap.wav", "start": 1176, "end": 194512}, {"filename": "/assets/sounds/gong.wav", "start": 194512, "end": 1261768}, {"filename": "/assets/sounds/open_door.wav", "start": 1261768, "end": 1389724}, {"filename": "/assets/sounds/piano_1.wav", "start": 1389724, "end": 1669208}, {"filename": "/assets/sounds/piano_2.wav", "start": 1669208, "end": 1910628}, {"filename": "/assets/sounds/piano_3.wav", "start": 1910628, "end": 2071100}, {"filename": "/assets/sounds/piano_4.wav", "start": 2071100, "end": 2299960}, {"filename": "/assets/sounds/pick_up_key.wav", "start": 2299960, "end": 2410612}, {"filename": "/assets/sounds/step_1.wav", "start": 2410612, "end": 2460576}, {"filename": "/assets/sounds/step_2.wav", "start": 2460576, "end": 2532556}, {"filename": "/assets/sounds/step_3.wav", "start": 2532556, "end": 2584824}, {"filename": "/assets/sounds/xylophone_1.wav", "start": 2584824, "end": 2785476}, {"filename": "/assets/sounds/xylophone_2.wav", "start": 2785476, "end": 3042966}, {"filename": "/assets/sounds/xylophone_3.wav", "start": 3042966, "end": 3307144}, {"filename": "/assets/sprites/broken_wall.bmp", "start": 3307144, "end": 4355858}, {"filename": "/assets/sprites/clap.bmp", "start": 4355858, "end": 5404572}, {"filename": "/assets/sprites/close_door.bmp", "start": 5404572, "end": 6453286}, {"filename": "/assets/sprites/gong.bmp", "start": 6453286, "end": 7502000}, {"filename": "/assets/sprites/key.bmp", "start": 7502000, "end": 8550714}, {"filename": "/assets/sprites/open_door.bmp", "start": 8550714, "end": 9599428}, {"filename": "/assets/sprites/piano_0.bmp", "start": 9599428, "end": 10648142}, {"filename": "/assets/sprites/piano_1.bmp", "start": 10648142, "end": 11696856}, {"filename": "/assets/sprites/piano_2.bmp", "start": 11696856, "end": 12745570}, {"filename": "/assets/sprites/piano_3.bmp", "start": 12745570, "end": 13794284}, {"filename": "/assets/sprites/piano_4.bmp", "start": 13794284, "end": 14842998}, {"filename": "/assets/sprites/stairs.bmp", "start": 14842998, "end": 15891712}, {"filename": "/assets/sprites/tuba.bmp", "start": 15891712, "end": 16940426}, {"filename": "/assets/sprites/wall.bmp", "start": 16940426, "end": 17989140}, {"filename": "/assets/sprites/xylophone.bmp", "start": 17989140, "end": 19037854}], "remote_package_size": 19037854});

  })();

// end include: C:\Users\JB\AppData\Local\Temp\tmpaj19w_qk.js
// include: C:\Users\JB\AppData\Local\Temp\tmpx28nhl9s.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\JB\AppData\Local\Temp\tmpx28nhl9s.js
// include: C:\Users\JB\AppData\Local\Temp\tmptythd2rl.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\JB\AppData\Local\Temp\tmptythd2rl.js
...
var ASM_CONSTS = {
  315892: () => { FS.syncfs(true, function(err) { if (err) console.error("FS sync failed", err); }); },  
 315975: ($0) => { var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return reply.length === 1 ? reply.charCodeAt(0) : -1; },  
 316190: () => { if (typeof(Module['SDL3']) === 'undefined') { Module['SDL3'] = {}; } Module['SDL3'].camera = {}; },  
 316291: () => { return (navigator.mediaDevices === undefined) ? 0 : 1; },  
 316350: ($0, $1, $2, $3, $4, $5, $6) => { const device = $0; const w = $1; const h = $2; const framerate_numerator = $3; const framerate_denominator = $4; const outcome = $5; const iterate = $6; const constraints = {}; if ((w <= 0) || (h <= 0)) { constraints.video = true; } else { constraints.video = {}; constraints.video.width = w; constraints.video.height = h; } if ((framerate_numerator > 0) && (framerate_denominator > 0)) { var fps = framerate_numerator / framerate_denominator; constraints.video.frameRate = { ideal: fps }; } function grabNextCameraFrame() { const SDL3 = Module['SDL3']; if ((typeof(SDL3) === 'undefined') || (typeof(SDL3.camera) === 'undefined') || (typeof(SDL3.camera.stream) === 'undefined')) { return; } const nextframems = SDL3.camera.next_frame_time; const now = performance.now(); if (now >= nextframems) { dynCall('vi', iterate, [device]); while (SDL3.camera.next_frame_time < now) { SDL3.camera.next_frame_time += SDL3.camera.fpsincrms; } } requestAnimationFrame(grabNextCameraFrame); } navigator.mediaDevices.getUserMedia(constraints) .then((stream) => { const settings = stream.getVideoTracks()[0].getSettings(); const actualw = settings.width; const actualh = settings.height; const actualfps = settings.frameRate; console.log("Camera is opened! Actual spec: (" + actualw + "x" + actualh + "), fps=" + actualfps); if (dynCall('iiiiii', outcome, [device, 1, actualw, actualh, actualfps])) { const video = document.createElement("video"); video.width = actualw; video.height = actualh; video.style.display = 'none'; video.srcObject = stream; const canvas = document.createElement("canvas"); canvas.width = actualw; canvas.height = actualh; canvas.style.display = 'none'; const ctx2d = canvas.getContext('2d'); const SDL3 = Module['SDL3']; SDL3.camera.width = actualw; SDL3.camera.height = actualh; SDL3.camera.fps = actualfps; SDL3.camera.fpsincrms = 1000.0 / actualfps; SDL3.camera.stream = stream; SDL3.camera.video = video; SDL3.camera.canvas = canvas; SDL3.camera.ctx2d = ctx2d; SDL3.camera.next_frame_time = performance.now(); video.play(); video.addEventListener('loadedmetadata', () => { grabNextCameraFrame(); }); } }) .catch((err) => { console.error("Tried to open camera but it threw an error! " + err.name + ": " + err.message); dynCall('iiiiii', outcome, [device, 0, 0, 0, 0]); }); },  
 318641: () => { const SDL3 = Module['SDL3']; if ((typeof(SDL3) === 'undefined') || (typeof(SDL3.camera) === 'undefined') || (typeof(SDL3.camera.stream) === 'undefined')) { return; } SDL3.camera.stream.getTracks().forEach(track => track.stop()); SDL3.camera = {}; },  
 318892: ($0, $1, $2) => { const w = $0; const h = $1; const rgba = $2; const SDL3 = Module['SDL3']; if ((typeof(SDL3) === 'undefined') || (typeof(SDL3.camera) === 'undefined') || (typeof(SDL3.camera.ctx2d) === 'undefined')) { return 0; } SDL3.camera.ctx2d.drawImage(SDL3.camera.video, 0, 0, w, h); const imgrgba = SDL3.camera.ctx2d.getImageData(0, 0, w, h).data; HEAPU8.set(imgrgba, rgba); return 1; },  
 319270: () => { if (typeof(Module['SDL3']) !== 'undefined') { Module['SDL3'].camera = undefined; } },  
 319357: () => { if (typeof(Module['SDL3']) === 'undefined') { Module['SDL3'] = {}; } Module['SDL3'].dummy_audio = {}; Module['SDL3'].dummy_audio.timers = []; Module['SDL3'].dummy_audio.timers[0] = undefined; Module['SDL3'].dummy_audio.timers[1] = undefined; },  
 319603: ($0, $1, $2, $3, $4) => { var a = Module['SDL3'].dummy_audio; if (a.timers[$0] !== undefined) { clearInterval(a.timers[$0]); } a.timers[$0] = setInterval(function() { dynCall('vi', $3, [$4]); }, ($1 / $2) * 1000); },  
 319795: ($0) => { var a = Module['SDL3'].dummy_audio; if (a.timers[$0] !== undefined) { clearInterval(a.timers[$0]); } a.timers[$0] = undefined; },  
 319926: () => { if (typeof(AudioContext) !== 'undefined') { return true; } else if (typeof(webkitAudioContext) !== 'undefined') { return true; } return false; },  
 320073: () => { if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return true; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return true; } return false; },  
 320307: ($0) => { if (typeof(Module['SDL3']) === 'undefined') { Module['SDL3'] = {}; } var SDL3 = Module['SDL3']; if (!$0) { SDL3.audio_playback = {}; } else { SDL3.audio_recording = {}; } if (!SDL3.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL3.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL3.audioContext = new webkitAudioContext(); } if (SDL3.audioContext) { if ((typeof navigator.userActivation) === 'undefined') { autoResumeAudioContext(SDL3.audioContext); } } } return (SDL3.audioContext !== undefined); },  
 320870: () => { return Module['SDL3'].audioContext.sampleRate; },  
 ...
 333177: ($0) => { var target = document.querySelector(UTF8ToString($0)); if (target) { var SDL3 = Module['SDL3']; target.removeEventListener("dragleave", SDL3.eventHandlerDropDragend); target.removeEventListener("dragend", SDL3.eventHandlerDropDragend); target.removeEventListener("drop", SDL3.eventHandlerDropDrop); SDL3.drop_count = undefined; function recursive_remove(dirpath) { FS.readdir(dirpath).forEach((filename) => { const p = `${dirpath}/${filename}`; const p_s = FS.stat(p); if (FS.isFile(p_s.mode)) { FS.unlink(p); } else if (FS.isDir(p)) { recursive_remove(p); } }); FS.rmdir(dirpath); }("/tmp/filedrop"); FS.rmdir("/tmp/filedrop"); target.removeEventListener("dragover", SDL3.eventHandlerDropDragover); SDL3.eventHandlerDropDragover = undefined; SDL3.eventHandlerDropDrop = undefined; SDL3.eventHandlerDropDragend = undefined; } },  
 334007: ($0) => { var target = document.querySelector(UTF8ToString($0)); if (target) { var SDL3 = Module['SDL3']; target.removeEventListener("pointerenter", SDL3.eventHandlerPointerEnter); target.removeEventListener("pointerleave", SDL3.eventHandlerPointerLeave); target.removeEventListener("pointercancel", SDL3.eventHandlerPointerLeave); target.removeEventListener("pointerdown", SDL3.eventHandlerPointerGeneric); target.removeEventListener("pointerup", SDL3.eventHandlerPointerGeneric); target.removeEventListener("pointermove", SDL3.eventHandlerPointerGeneric); SDL3.eventHandlerPointerEnter = undefined; SDL3.eventHandlerPointerLeave = undefined; SDL3.eventHandlerPointerGeneric = undefined; } },  
 334692: () => { if (!window.matchMedia) { return -1; } if (window.matchMedia('(prefers-color-scheme: light)').matches) { return 0; } if (window.matchMedia('(prefers-color-scheme: dark)').matches) { return 1; } return -1; },  
 334901: () => { if (typeof(Module['SDL3']) !== 'undefined') { var SDL3 = Module['SDL3']; SDL3.themeChangedMatchMedia.removeEventListener('change', SDL3.eventHandlerThemeChanged); SDL3.themeChangedMatchMedia = undefined; SDL3.eventHandlerThemeChanged = undefined; } },  
 335154: () => { return window.innerWidth; },  
 335184: () => { return window.innerHeight; },  
 335215: ($0) => { Module['requestFullscreen'] = function(lockPointer, resizeCanvas) { _requestFullscreenThroughSDL($0); }; },  
 335324: () => { Module['requestFullscreen'] = function(lockPointer, resizeCanvas) {}; },  
 335398: () => { if (window.matchMedia) { if (typeof(Module['SDL3']) === 'undefined') { Module['SDL3'] = {}; } var SDL3 = Module['SDL3']; SDL3.eventHandlerThemeChanged = function(event) { _Emscripten_SendSystemThemeChangedEvent(); }; SDL3.themeChangedMatchMedia = window.matchMedia('(prefers-color-scheme: dark)'); SDL3.themeChangedMatchMedia.addEventListener('change', SDL3.eventHandlerThemeChanged); } }
};
